...
public class CategoryFragment extends Fragment {
    ...
    private Call<CategoriesCallback> callbackCall = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdapter = new CategoryAdapter(getActivity(), new ArrayList<>());
    ...
    private void requestCategoriesApi() {
        ...
        callbackCall.enqueue(new Callback<CategoriesCallback>() {
            @Override
            public void onResponse(Call<CategoriesCallback> call, Response<CategoriesCallback> response) {
                CategoriesCallback resp = response.body();
            ...
            @Override
            public void onFailure(Call<CategoriesCallback> call, Throwable t) {
