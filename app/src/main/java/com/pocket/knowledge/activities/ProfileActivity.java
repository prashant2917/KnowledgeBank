...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void initComponent() {
        ...
        findViewById(R.id.btn_privacy_policy).setOnClickListener(view -> startActivity(new Intent(getApplicationContext(), PrivacyPolicyActivity.class)));
    ...
    private void requestAction() {
        if (myApplication.getIsLogin()) {
            ...
            txt_login.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), UserLoginActivity.class)));
            txt_register.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), UserRegisterActivity.class)));
