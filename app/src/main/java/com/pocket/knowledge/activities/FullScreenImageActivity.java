...
public class FullScreenImageActivity extends AppCompatActivity {
    ...
    private void requestStoragePermission() {
        Dexter.withActivity(FullScreenImageActivity.this)
                .withPermissions(
                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        ...
                        if (report.areAllPermissionsGranted()) {
                            (new saveImage(FullScreenImageActivity.this)).execute(AppConfig.ADMIN_PANEL_URL + "/upload/" + str_image);
                        }
    ...
    public class saveImage extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                MediaScannerConnection.scanFile(FullScreenImageActivity.this, as, null, new android.media.MediaScannerConnection.OnScanCompletedListener() {
