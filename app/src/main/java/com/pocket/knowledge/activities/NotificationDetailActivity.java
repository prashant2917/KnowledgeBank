...
public class NotificationDetailActivity extends AppCompatActivity {
    ...
    private void onFailRequest() {
        swipeProgress(false);
        lyt_main_content.setVisibility(View.GONE);
        if (NetworkCheck.isConnect(NotificationDetailActivity.this)) {
    ...
    private void displayImages(final List<Images> list) {
        ...
        final ImageAdapter adapter = new ImageAdapter(NotificationDetailActivity.this, list);
    ...
    private void displayRelated(List<News> list) {
        ...
        RelatedAdapter adapterNews = new RelatedAdapter(NotificationDetailActivity.this, recyclerView, list);
    ...
    private void loadInterstitialAd() {
        if (AdsConfig.INTERSTITIAL_ON_NEWS_LIST) {
            ...
            interstitialAd.setAdListener(new AdListener() {
                @Override
                public void onAdClosed() {
                    interstitialAd.loadAd(Tools.getAdRequest(NotificationDetailActivity.this));
                }
            });
        }
    }
