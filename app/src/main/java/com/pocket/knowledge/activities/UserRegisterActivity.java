...
public class UserRegisterActivity extends AppCompatActivity implements Validator.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_terms.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), PrivacyPolicyActivity.class)));
    ...
    public void onValidationSucceeded() {
        ...
        if (NetworkCheck.isNetworkAvailable(UserRegisterActivity.this)) {
